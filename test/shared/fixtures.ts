...
import UniswapV2Factory from '@thinkanddev/rskswap-core/build/UniswapV2Factory.json'
import IUniswapV2Pair from '@thinkanddev/rskswap-core/build/IUniswapV2Pair.json'
